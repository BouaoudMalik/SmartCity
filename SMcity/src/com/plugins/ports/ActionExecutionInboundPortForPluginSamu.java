...
public class ActionExecutionInboundPortForPluginSamu extends AbstractInboundPort implements ActionExecutionCI {
	 ...
	 * 
	 */
	public ActionExecutionInboundPortForPluginSamu(String uri, ComponentI owner, String pluginURI) throws Exception {
	 ...
	 * 
	 */
	public ActionExecutionInboundPortForPluginSamu(ComponentI owner, String pluginURI) throws Exception {
	...
	public ResponseI executeAction(ActionI a, Serializable[] params) throws Exception {
		return ((SAMUStationFacade) this.getOwner()).executeAction(a, params);
	}
