...
public class ActionExecutionInboundPortForPluginTraffic extends AbstractInboundPort implements ActionExecutionCI {
	 ...
	 * 
	 */
	public ActionExecutionInboundPortForPluginTraffic(String uri, ComponentI owner, String pluginURI) throws Exception {
	 ...
	 * 
	 */
	public ActionExecutionInboundPortForPluginTraffic(ComponentI owner, String pluginURI) throws Exception {
	...
	public ResponseI executeAction(ActionI a, Serializable[] params) throws Exception {
		return ((TrafficLightFacade) this.getOwner()).executeAction(a, params);
	}
