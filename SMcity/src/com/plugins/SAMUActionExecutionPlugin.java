...
import com.plugins.ports.ActionExecutionInboundPortForPluginSamu;

import fr.sorbonne_u.components.AbstractPlugin;
import fr.sorbonne_u.components.AbstractPort;
import fr.sorbonne_u.components.ComponentI;

public class SAMUActionExecutionPlugin extends AbstractPlugin implements ActionExecutionCI {
	...
	protected ActionExecutionInboundPortForPluginSamu actionExecutionIBP;
	...
	public SAMUActionExecutionPlugin() {
		super();
	}
	...
	public void initialise() throws Exception {
		...
		this.actionExecutionIBP = new ActionExecutionInboundPortForPluginSamu(this.actionPlugin_URI, this.getOwner(),
				this.getPluginURI());
